...
if (MSVC)
    ...
    add_custom_target(GMP SOURCES ${_output})
    ...
    ExternalProject_Add(GMP
            ...
            DOWNLOAD_DIR ${DEPS_DOWNLOAD_DIR}/GMP
            BUILD_IN_SOURCE ON
            CONFIGURE_COMMAND  env "CFLAGS=${_gmp_ccflags}" "CXXFLAGS=${_gmp_ccflags}" ./configure ${_cross_compile_arg} --enable-shared=no --enable-cxx=yes --enable-static=yes "--prefix=${DEPS_INSTALL_DIR}/usr/local" ${_gmp_build_tgt}
