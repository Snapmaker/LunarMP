...
set(_dstdir ${DEPS_INSTALL_DIR}/usr/local)
...
if (MSVC)
    ...
    add_custom_target(MPFR SOURCES ${_output})
    ...
    ExternalProject_Add(MPFR
        ...
        DOWNLOAD_DIR ${DEPS_DOWNLOAD_DIR}/MPFR
        BUILD_IN_SOURCE ON
        CONFIGURE_COMMAND env "CFLAGS=${_gmp_ccflags}" "CXXFLAGS=${_gmp_ccflags}" ./configure ${_cross_compile_arg} --prefix=${DEPS_INSTALL_DIR}/usr/local --enable-shared=no --enable-static=yes --with-gmp=${DEPS_INSTALL_DIR}/usr/local ${_gmp_build_tgt}
