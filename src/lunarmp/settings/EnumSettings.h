...
/*!
 * In tpp different infill methods are available.
 ...
 */
enum class EPlatformAdhesion { SKIRT, BRIM, RAFT, NONE };

/*!
 * Type of support material to generate
 */
enum class ESupportType { NONE, PLATFORM_ONLY, EVERYWHERE };

/*!
 * Structure of the support, such as Tree Support
 */
enum class ESupportStructure { NORMAL, TREE };

enum class EZSeamType { RANDOM, SHORTEST, USER_SPECIFIED, SHARPEST_CORNER };
...
enum class ESurfaceMode { NORMAL, SURFACE, BOTH };

enum class FillPerimeterGapMode { NOWHERE, EVERYWHERE };

enum class BuildPlateShape { RECTANGULAR, ELLIPTIC };

enum class CombingMode { OFF, ALL, NO_SKIN, INFILL };
...
enum class SupportDistPriority { XY_OVERRIDES_Z, Z_OVERRIDES_XY };

enum class SlicingTolerance { MIDDLE, INCLUSIVE, EXCLUSIVE };
/*!
